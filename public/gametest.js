...
class Game extends Phaser.Scene {
  ...
  create() {
    ...
    this.ball.body.setVelocity(
      Phaser.Math.Between(550, 600),
      Phaser.Math.Between(250, 300)
    );
  ...
  update() {
    ...
    if (this.cursors.up.isDown && this.paddleLeft.y > 50) {
      ...
      this.paddleLeft.y < this.canvas.height - 50
    ) {
    ...
    //console.log(diff);
    if (
      this.paddleRight.y + diff > 50 &&
      this.paddleRight.y + diff < this.canvas.height - 50
    ) {
